 ...
 * ~~~~~~~~~
 * 
 * Some stuff to make working with node.js easier for me.
 *
...
exports.get = function (path, handler) {
    dispatchMap[path] = handler;
};

var server = http.createServer(function (req, res) {
    var handler = dispatchMap[url.parse(req.url).pathname] || notFound;
...
exports.staticHandler = function (filename) {
    var body,
        headers,
        content_type = exports.mime.lookupExtension(getExtension(filename)),
...
exports.listen = function (port, host) {
    ...
    sys.puts(["Server started at http://",
            (host || "127.0.0.1"), ":",
            port.toString(), "/"].join(''));
};
